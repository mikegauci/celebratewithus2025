...
export const guestList: GuestData[] = [
  ...
  { slug: 'oiseje' },
  { slug: 'junjie' },
  { slug: 'andre', displayName: 'André' },
  { slug: 'teddie', companion: 'Olena' },
  { slug: 'ryan-agius', displayName: 'Ryan', companion: 'Kimberly' },
  { slug: 'mauro' },
  { slug: 'abigail' },
  { slug: 'james' },
  { slug: 'dory-jean', displayName: 'Dory Jean', companion: 'Darren and Mary' },
  { slug: 'dr-christopher', displayName: 'Dr Christopher' },
  { slug: 'bernard' },
  { slug: 'prof-and-mrs-cilia-vincenti', displayName: 'Prof.', companion: 'Mrs Cilia Vincenti' },
];
